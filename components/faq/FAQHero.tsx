  ...
  return (
    <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden bg-black pt-20">
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-red-900/15 rounded-full blur-[100px]" />
      </div>
      <div className="relative z-10 max-w-3xl mx-auto px-4 text-center">
        ...
        >
          RESOLVEMOS TUS{" "}
          <span className="text-red-500">DUDAS</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          Todo lo que necesitas saber sobre el proceso anti-okupa, legalidad y cómo trabajamos.
        </motion.p>
      </div>
    </section>
  );
