  ...
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-black pt-20">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        >
          EL EQUIPO QUE{" "}
          <span className="text-red-500">RECUPERA</span>{" "}
          TU PROPIEDAD
        </motion.h1>
        ...
        >
          Más de 10 años combinando experiencia táctica, conocimiento legal y un compromiso
          inquebrantable con el propietario. Somos Youssef OK.
        </motion.p>
      </div>
    </section>
  );
