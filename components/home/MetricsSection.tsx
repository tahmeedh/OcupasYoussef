...
const icons = [Home, TrendingUp, Clock, Phone];
const values = [500, 98, 24, 247];
const suffixes = ["+", "%", "h", ""];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-black text-white mb-4"
            ...
            {t.metrics.headline1}{" "}
            <span className="text-red-500">{t.metrics.headline2}</span>
          </h2>
          <p className="text-gray-400 text-lg">{t.metrics.sub}</p>
        </motion.div>
                ...
                <div className="mb-2">
                  <span className="text-5xl sm:text-6xl font-black text-white"
                    ...
                    {values[i] === 247 ? (
                      ...
                      <AnimatedCounter end={values[i]} suffix={suffixes[i]} duration={2000} />
                    )}
                  </span>
                </div>
